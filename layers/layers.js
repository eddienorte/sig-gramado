...
var lyr_GRAMADO_CANELA0 = new ol.layer.Image({
    ...
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
                        ...
                        });var format_Gramado1 = new ol.format.GeoJSON();
var features_Gramado1 = format_Gramado1.readFeatures(json_Gramado1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Gramado1 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_Gramado1.addFeatures(features_Gramado1);var lyr_Gramado1 = new ol.layer.Vector({
                source:jsonSource_Gramado1, 
                style: style_Gramado1,
                title: '<img src="styles/legend/Gramado1.png" /> Gramado'
            });var format_Canela2 = new ol.format.GeoJSON();
var features_Canela2 = format_Canela2.readFeatures(json_Canela2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Canela2 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_Canela2.addFeatures(features_Canela2);var lyr_Canela2 = new ol.layer.Vector({
                source:jsonSource_Canela2, 
                style: style_Canela2,
                title: '<img src="styles/legend/Canela2.png" /> Canela'
...
var group_LimitesMunicpais = new ol.layer.Group({
                                layers: [lyr_Gramado1,lyr_Canela2,],
...
lyr_GRAMADO_CANELA0.setVisible(false);lyr_Gramado1.setVisible(false);lyr_Canela2.setVisible(false);lyr_Gramado3.setVisible(false);lyr_Canela4.setVisible(false);lyr_Ruas5.setVisible(false);lyr_PontosTuristicos6.setVisible(false);lyr_Hoteis7.setVisible(false);
...
lyr_Gramado1.set('fieldAliases', {'NM_MUNICIP': 'NM_MUNICIP', 'CD_GEOCMU': 'CD_GEOCMU', 'POPULAÇÃ': 'POPULAÇÃ', 'ÁREA': 'ÁREA', 'BIOMA': 'BIOMA', 'ALTITUDE': 'ALTITUDE', 'FUNDADA': 'FUNDADA', });
lyr_Canela2.set('fieldAliases', {'NM_MUNICIP': 'NM_MUNICIP', 'CD_GEOCMU': 'CD_GEOCMU', });
...
lyr_Gramado1.set('fieldImages', {'NM_MUNICIP': 'TextEdit', 'CD_GEOCMU': 'TextEdit', 'POPULAÇÃ': 'TextEdit', 'ÁREA': 'TextEdit', 'BIOMA': 'TextEdit', 'ALTITUDE': 'TextEdit', 'FUNDADA': 'TextEdit', });
lyr_Canela2.set('fieldImages', {'NM_MUNICIP': 'TextEdit', 'CD_GEOCMU': 'TextEdit', });
...
lyr_Gramado1.set('fieldLabels', {});
lyr_Canela2.set('fieldLabels', {});
